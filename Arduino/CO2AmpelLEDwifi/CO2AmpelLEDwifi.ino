...
void startWiFi() { // Try to connect to some given access points. Then wait for a connection
  wifiMulti.addAP("wlan-ssid1", "wlan-password1");   // add Wi-Fi networks you want to connect to
  wifiMulti.addAP("wlan-ssid2", "wlan-password2");   // add Wi-Fi networks you want to connect to
  wifiMulti.addAP("wlan-ssid3", "wlan-password3");   // add Wi-Fi networks you want to connect to
